...
@Component({
  selector: 'multi-content-layout',
  templateUrl: './multi-content-layout.component.html'
  /*styleUrls: ['./two-by-two-layout.component.scss']*/
})
export class MultiContentLayoutComponent extends LayoutComponent implements AfterViewInit {
