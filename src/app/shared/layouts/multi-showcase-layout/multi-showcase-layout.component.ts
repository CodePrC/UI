...
@Component({
  selector: 'multi-showcase-layout',
  templateUrl: './multi-showcase-layout.component.html'
  /*styleUrls: ['./two-by-two-layout.component.scss']*/
})
export class MultiShowcaseLayoutComponent extends LayoutComponent implements AfterViewInit {
